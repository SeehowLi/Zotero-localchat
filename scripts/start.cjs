...
(async()=>{
  ...
  for(let i=0;i<50;i++){await new Promise(r=>setTimeout(r,100));try{const e=JSON.parse(fs.readFileSync(file,'utf8'));if(e.pid===child.pid){console.log('Local Chat 已启动，在 Zotero 点击“论文对话”即可。');return;}}catch{}}
