...
$xpi=Join-Path $dist 'Zotero-localchat-0.4.12.xpi'
...
$zip=Join-Path $dist 'Zotero-localchat-0.4.12-windows.zip'
...
try {
  ...
  [IO.Compression.ZipFileExtensions]::CreateEntryFromFile($archive,$xpi,'Zotero-localchat-0.4.12.xpi') | Out-Null
