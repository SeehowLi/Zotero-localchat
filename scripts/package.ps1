...
$xpi=Join-Path $dist 'Zotero-localchat-0.4.3.xpi'
...
$zip=Join-Path $dist 'Zotero-localchat-0.4.3-windows.zip'
...
try {
  ...
  [IO.Compression.ZipFileExtensions]::CreateEntryFromFile($archive,$xpi,'Zotero-localchat-0.4.3.xpi') | Out-Null
