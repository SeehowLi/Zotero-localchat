...
$xpi=Join-Path $dist 'Zotero-localchat-0.4.11.xpi'
...
$zip=Join-Path $dist 'Zotero-localchat-0.4.11-windows.zip'
...
try {
  ...
  [IO.Compression.ZipFileExtensions]::CreateEntryFromFile($archive,$xpi,'Zotero-localchat-0.4.11.xpi') | Out-Null
